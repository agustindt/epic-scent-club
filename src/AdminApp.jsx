...
import { LayoutDashboard, Package, Users, ShoppingBag, MessageCircle, AlertTriangle, Database, ExternalLink } from 'lucide-react'
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/catalogo"
                target="_blank"
                className="hidden sm:flex items-center gap-1.5 text-xs text-obsidian-400 hover:text-gold-400 border border-obsidian-700 hover:border-gold-700/50 rounded-lg px-3 py-1.5 transition-colors"
              >
